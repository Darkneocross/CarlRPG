...
public class Monster extends Character {
    ...
    public void monsterCreate() {
        ...
        monsterList.add(new Monster("Tyler", 10, 10, 1, 0, 3, 3, 1, 3)); //4
        monsterList.add(new Monster("Slime", 7, 7, 2, 0, 1, 1, 0, 2)); //5
        monsterList.add(new Monster("Blob", 8, 8, 1, 0, 1, 1, 0, 2)); //6
        monsterList.add(new Monster("Pig", 7, 7, 3, 0, 1, 1, 0, 4)); //7
        monsterList.add(new Monster("Skeleton", 9, 9, 2, 0, 1, 1, 0, 2)); //8
        monsterList.add(new Monster("Undead", 9, 9, 1, 0, 2, 2, 0, 1)); //9
